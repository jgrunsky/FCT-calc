...
assert.ok(/2026-09-07-fct-calc-v2\.1\.49-no-fuel-bar/.test(html), 'APP_VERSION is v2.1.49-no-fuel-bar');
assert.ok(/v2\.1\.49-no-fuel-bar/.test(html), 'changelog has v2.1.49-no-fuel-bar');
assert.ok(/v2\.1\.48-pnl-today/.test(html), 'changelog still has v2.1.48-pnl-today');
