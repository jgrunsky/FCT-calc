...

{
  ...
  assert.ok(/2026-08-25-fct-calc-v2\.1\.41-excel-sms/.test(html), 'APP_VERSION is v2.1.41');
  assert.ok(/v2\.1\.40-adp-blend/.test(html), 'changelog still has v2.1.40 ADP blend');
  assert.ok(/v2\.1\.41-excel-sms/.test(html), 'changelog has v2.1.41 excel+sms');
